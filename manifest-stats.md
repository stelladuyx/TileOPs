...
![ops](https://img.shields.io/badge/ops-189-blue) ![implemented](https://img.shields.io/badge/implemented-170%20%2F%20189%20%2890%25%29-brightgreen) ![spec--only](https://img.shields.io/badge/spec--only-19-orange)
...
| --- | ---: |
| `ref_api` | 189 / 189 (100%) |
| `roofline` (func or flops+bytes) | 189 / 189 (100%) |
| `source.kernel_map` | 179 / 189 (95%) |
| `source.bench_manifest_driven` | 170 / 189 (90%) |

**Workloads:** 630 total — 3.54 per implemented op.
